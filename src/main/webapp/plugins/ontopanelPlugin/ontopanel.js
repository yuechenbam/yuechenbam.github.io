(() => {
  ...
  var e = {
      398: (e, t, o) => {
        ...
        l.push([
          e.id,
          ".error-list{margin-top:5px;overflow:auto;padding:5px}.error-list .error-type{font-size:14px;background-color:#d3d3d3;font-weight:bold}.error-list ul{padding-left:12px}.error-list ul li{margin:10px;cursor:pointer}.error-list hr{border-top:2px solid #000;margin-bottom:5px}.mapping-tool form{display:flex}.mapping-tool form .selector,.mapping-tool form .selector-seperator{border:1px solid #777;border-radius:4px;padding:0 px;width:80px;background-color:#fff;position:relative}.mapping-tool form .selector label,.mapping-tool form .selector-seperator label{width:100%;font-size:8px;text-transform:uppercase;color:#777;padding:0 5px;position:absolute;top:4px}.mapping-tool form .selector select,.mapping-tool form .selector-seperator select{margin-top:10px;width:100%;background-color:#fff;border:0px;height:17px;font-size:13px}.mapping-tool form .selector select option,.mapping-tool form .selector-seperator select option{font-size:13px;font-weight:bold}.mapping-tool form .selector input,.mapping-tool form .selector-seperator input{margin-top:10px;width:95%;background-color:#fff;border:0px;height:17px}.mapping-tool form .file-upload input{height:17px;width:50px;border:none;border-radius:2px;cursor:pointer;color:#000;background-color:#d3d3d3}.mapping-tool form .file-upload input:hover{background-color:gray}.mapping-tool form input{border:none;border-radius:2px;cursor:pointer;color:#000;background-color:#d3d3d3}.mapping-tool form input:hover{background-color:gray}.mapping-tool .mapping-error{display:none;color:red}.mapping-tool .mapping-table{height:285px;width:100%;overflow:auto}.mapping-tool .mapping-table table{height:100%;width:100%;border-collapse:collapse}.mapping-tool .mapping-table table th{font-size:13px;border:1px solid #000;position:sticky;top:0px;text-align:left;background-color:#a9a9a9;color:#000;padding:5px}.mapping-tool .mapping-table table th input{margin-right:3px;padding:0px;border:none;cursor:pointer;font-size:11px;background-color:transparent}.mapping-tool .mapping-table table th input:hover{background-color:#d3d3d3}.mapping-tool .mapping-table table tr:nth-child(odd){background-color:#ddd}.mapping-tool .mapping-table table td{border:1px solid #000;text-align:left;font-size:11px;padding:5px}.mapping-tool .mapping-count{font-size:11px;font-weight:bold}.mapping-tool .mapping-reset-btn{margin-left:5px;padding:2px;border:none;border-radius:2px;font-size:11px;cursor:pointer;color:#fff;background-color:#4682b4}.mapping-tool .mapping-reset-btn:hover{background-color:#00008b}.convertor-container{width:100%;height:100%}.convertor-container .convertor-bar{height:30px;min-width:150px;margin-bottom:10px;display:flex;align-items:center}.convertor-container .convertor-bar select{height:100%;border:none;border-radius:2px}.convertor-container .convertor-bar .mapping-convert-btn{padding:5px;border:none;border-radius:2px;font-size:14px;cursor:pointer;color:#fff;background-color:#4682b4}.convertor-container .convertor-bar .mapping-convert-btn:hover{background-color:#00008b}.convertor-container .convertor-bar .mapping-info{margin-left:5px;font-size:12px;color:#a9a9a9}.convertor-container .transformer{font-size:12px;display:flex;margin-bottom:8px}.convertor-container .transformer input{margin-left:5px;padding:2px;border:none;border-radius:2px;cursor:pointer;color:#fff;background-color:#4682b4}.convertor-container .transformer input:hover{background-color:#00008b}.convertor-container .convertor-show{border:1px solid #000;height:360px}.convertor-container .convertor-show .convertor-btn-group{display:flex;width:100%}.convertor-container .convertor-show .convertor-btn-group input{width:100%;padding:5px;border:none;border-radius:2px;font-size:14px;cursor:pointer;color:#fff;background-color:#4682b4}.convertor-container .convertor-show .convertor-btn-group input:hover{background-color:#00008b}.convertor-container .convertor-show .convertor-content{font-size:14px;height:340px;overflow:auto}",
          "",
        ]);
        const a = l;
      },
    ...
    (() => {
      ...
      const k = class {
          ...
          init() {
            ...
            (this.btn.id = t),
              C.modifyOntoBank([t, this.data], "add"),
              (this.btn.onclick = (e) => {
                e.preventDefault();
                let t = this.btn.id,
                  o = C.ontoBank[t];
                C.loadCurrentTable(o);
              }),
              this.btn.addEventListener("contextmenu", (e) => {
                e.preventDefault(), this.triggerMenu();
              }),
          ...
          showOntoInfo = () => {
            let e = this.btn.id,
              t = C.ontoBank[e].title,
              o = C.ontoBank[e].onto_source,
              n = C.ontoBank[e].date_created,
          ...
          deleteOnto = () => {
            ...
            o
              ? ((o = JSON.parse(o)),
                fetch(t + "api/v1/ontos/change/" + n, {
                  ...
                  .then((t) => {
                    t.ok
                      ? (C.ontoBank[e].title ==
                          C.currentCategoriesContent.title &&
                          C.loadCurrentTable(null, "reset"),
                        C.modifyOntoBank([e, null], "delete"),
                        this.btn.remove(),
                        this.handleInfoToggle(
                          "Deleted in your databank!",
                          "green"
              ...
              : (C.ontoBank[e].title == C.currentCategoriesContent.title &&
                  C.loadCurrentTable(null, "reset"),
                C.modifyOntoBank([e, null], "delete"),
                this.btn.remove(),
                this.handleInfoToggle("Deleted locally", "green"));
        ...
        T = class {
          ...
          ontoAddFormToggle = (e) => {
            ...
            if (n.size || r)
              if (
                Object.keys(C.ontoBank).includes(
          ...
          updateOntoBtn = (e, t) => {
            ...
            (o.id = r),
              C.modifyOntoBank([t, null], "delete"),
              C.modifyOntoBank([r, e], "add"),
              C.loadCurrentTable(e);
          };
          ontoUpdateDB = (e, o, n) => {
            n = JSON.parse(n);
            let r = C.ontoBank[o].id;
            fetch(t + "api/v1/ontos/change/" + r, {
              method: "PUT",
              body: e,
              headers: new Headers({ Authorization: `Token ${n.token}` }),
        ...
        O = (e, t, o, n, r) => {
          ...
          return (
            t.forEach((t) => {
              ...
              u.innerHTML = t[0];
              let h = u.innerText;
              if ("RDFLabel" === C.setting) {
                let e = C.currentCategoriesContent.table[h].RDFLabel;
                if (e.length) {
        ...
        E = (e, t) => {
          let o = t.cloneNode(!0),
            n = e.replace("li-term-", ""),
            r = C.currentCategoriesContent.table[n];
          return (
            ...
            (o.querySelector('div[name="entity-annos"]').innerHTML = q(
              r.Annotations
            ).innerHTML),
            (o.querySelector('div[name="entity-special"]').innerHTML = q(
              r.SpecialInfo
            ).innerHTML),
            (o.onclick = (e) => {
              e.stopPropagation();
        ...
        I = (e, t, o, n, r) => {
          let i,
            l = t.replace("li-term-", ""),
            a = 0,
            s = C.currentCategoriesContent.table[l],
            d = s.BelongsTo,
            p = s.Color,
            c = e;
          switch (d) {
        ...
        M = (e) => {
          ...
          return (
            ...
            (a.onclick = (e) => {
              ...
              (t.textContent = N.result), d.firstElementChild.replaceWith(t);
            }),
            (s.onclick = (t) => {
              if (N.errors) {
                let t = ((e, t) => {
            ...
            (r.onclick = (n) => {
              ...
              let r = ((e) => {
                ...
                i = {
                  format: o.querySelector("select").value,
                  fileData: r,
              ...
              N.modifyData({ result: "In process, please wait", errors: null }),
                ...
                fetch(t + "api/v1/convertor/", {
                  ...
                  .then((e) => {
                    e.ok
                      ? e.json().then((e) => {
                          N.modifyData(e), a.click();
                        })
                      : e.json().then((e) => {
                          let t = {
                            result: e[Object.keys(e)[0]],
                            errors: null,
                          };
                          N.modifyData(t), a.click();
                        });
                  })
                  .catch((e) => {
        ...
        let l = ((e) => {
          ...
          Object.keys(s).forEach((t) => {
            o.querySelector("#" + t).onclick = (t) => {
              let r = C.currentCategoriesContent.categories[s[t.target.id]],
              ...
              if (r.content) {
                let t = new (class {
                  ...
                  search = (e) => {
                    ...
                    if (t.length) {
                      this.collpaseAll();
                      let o = C.currentCategoriesContent.table;
            ...
            (o.querySelector("#ontopanel-onto-extra-btn-MSEO").onclick = (
              ...
              e.preventDefault(),
                fetch("plugins/ontopanelPlugin/ontoData/mseo_ontopanel.json")
                  .then((e) => e.json())
                  .then((e) => {
                    (e.onto_table.namespaces = C.mesoNamespace),
                      C.modifyOntoBank(
            ...
            (o.querySelector("#ontopanel-namespace-btn").onclick = (t) => {
              if (
                (t.preventDefault(),
                "none" !== C.currentCategoriesContent.title)
              ) {
                let o =
                    C.ontoBank[
                ...
                let d = mxUtils.convertPoint(a.container, n.getX(), n.getY()),
                  ...
                  m = p.y / u - c.y;
                const y = [r];
                e.editor.graph.importCells(y, h, m);
              }
            });
            ...
            (l.querySelector('button[name="namespace-btn"]').onclick = (t) => {
              if ((t.preventDefault(), e.currentCategoriesContent.title)) {
                ...
                let l = i.width + 30,
                  ...
                  m = p.y / u - c.y;
                const y = [r];
                o.editor.graph.importCells(y, h, m);
              }
            }),
            a
          );
