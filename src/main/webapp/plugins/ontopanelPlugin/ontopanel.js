    ...
    (() => {
      ...
      const C = class {
          ...
          init() {
            ...
            (this.btn.id = t),
              k.modifyOntoBank([t, this.data], "add"),
              (this.btn.onclick = (e) => {
                e.preventDefault();
                let t = this.btn.id,
                  o = k.ontoBank[t];
                k.loadCurrentTable(o);
              }),
              this.btn.addEventListener("contextmenu", (e) => {
                e.preventDefault(), this.triggerMenu();
              }),
          ...
          showOntoInfo = () => {
            let e = this.btn.id,
              t = k.ontoBank[e].title,
              o = k.ontoBank[e].onto_source,
              n = k.ontoBank[e].date_created,
          ...
          deleteOnto = () => {
            ...
            o
              ? ((o = JSON.parse(o)),
                fetch(t + "api/v1/ontos/change/" + n, {
                  ...
                  .then((t) => {
                    t.ok
                      ? (k.ontoBank[e].title ==
                          k.currentCategoriesContent.title &&
                          k.loadCurrentTable(null, "reset"),
                        k.modifyOntoBank([e, null], "delete"),
                        this.btn.remove(),
                        this.handleInfoToggle(
                          "Deleted in your databank!",
                          "green"
              ...
              : (k.ontoBank[e].title == k.currentCategoriesContent.title &&
                  k.loadCurrentTable(null, "reset"),
                k.modifyOntoBank([e, null], "delete"),
                this.btn.remove(),
                this.handleInfoToggle("Deleted locally", "green"));
        ...
        T = class {
          ...
          ontoAddFormToggle = (e) => {
            ...
            if (n.size || r)
              if (
                Object.keys(k.ontoBank).includes(
          ...
          updateOntoBtn = (e, t) => {
            ...
            (o.id = r),
              ...
              k.modifyOntoBank([r, e], "add"),
              k.loadCurrentTable(e);
          };
          ontoUpdateDB = (e, o, n) => {
            n = JSON.parse(n);
            let r = k.ontoBank[o].id;
            fetch(t + "api/v1/ontos/change/" + r, {
              method: "PUT",
              body: e,
              headers: new Headers({ Authorization: `Token ${n.token}` }),
        ...
        I = (e, t, o, n, r) => {
          ...
          return (
            t.forEach((t) => {
              ...
              u.innerHTML = t[0];
              let h = u.innerText;
              if ("RDFLabel" === k.setting) {
                let e = k.currentCategoriesContent.table[h].RDFLabel;
                if (e.length) {
        ...
        O = (e, t) => {
          let o = t.cloneNode(!0),
            n = e.replace("li-term-", ""),
            r = k.currentCategoriesContent.table[n];
          return (
        ...
        E = (e, t, o, n, r) => {
          let i,
            l = t.replace("li-term-", ""),
            a = 0,
            s = k.currentCategoriesContent.table[l],
            d = s.BelongsTo,
            p = s.Color,
            c = e;
          switch (d) {
                  ...
                  switch (i.toLowerCase()) {
                    ...
                    case "datatypeproperty":
                      ...
                      if (d.includes("rhombus") | t.isEdge()) {
                        let i = { label: L(n, e), Type: a, IRI: r.EntityIRI },
                          l = j(i);
                        o.editor.graph.model.setStyle(t, p),
        ...
        X = (e) => {
          ...
          return (
            ...
            (a.onclick = (e) => {
              ...
              (t.textContent = z.result), d.firstElementChild.replaceWith(t);
            }),
            (s.onclick = (t) => {
              if (z.errors) {
                let t = ((e, t) => {
            ...
            (r.onclick = (n) => {
              ...
              let r = ((e) => {
                  ...
                  return (
                    ...
                    JSON.stringify({ nodes: i, edges: l, errors: a }),
                    { nodes: i, edges: l, errors: a }
                  );
                })(e),
                i = { format: o.querySelector("select").value, data: r };
              z.modifyData({ result: "In process, please wait", errors: null }),
                a.click(),
                fetch(t + "api/v1/convertor/", {
                  ...
                  .then((e) => {
                    e.ok
                      ? e.json().then((e) => {
                          z.modifyData(e), a.click();
                        })
                      : e.json().then((e) => {
                          let t = { result: e, errors: null };
                          z.modifyData(t), a.click();
                        });
                  })
                  .catch((e) => {
                    let t = { result: e, errors: null };
        ...
        let l = ((e) => {
          ...
          Object.keys(s).forEach((t) => {
            o.querySelector("#" + t).onclick = (t) => {
              let r = k.currentCategoriesContent.categories[s[t.target.id]],
                ...
                let t = new (class {
                  ...
                  init() {
                    ...
                    let r = e.querySelector("li"),
                      ...
                      l = this.data.content,
                      a = I(this.ui, l, r, this.wnd, this.treeContent);
                    i.replaceWith(a);
                  }
                  foldAll = () => {
                  ...
                  search = (e) => {
                    ...
                    if (t.length) {
                      this.collpaseAll();
                      let o = k.currentCategoriesContent.table;
            ...
            (o.querySelector("#ontopanel-onto-extra-btn-MSEO").onclick = (
              ...
              e.preventDefault(),
                fetch("plugins/ontopanelPlugin/ontoData/mseo_ontopanel.json")
                  .then((e) => e.json())
                  .then((e) => {
                    (e.onto_table.namespaces = k.mesoNamespace),
                      k.modifyOntoBank(
            ...
            (o.querySelector("#ontopanel-namespace-btn").onclick = (t) => {
              if (
                (t.preventDefault(),
                "none" !== k.currentCategoriesContent.title)
              ) {
                let o =
                    k.ontoBank[
